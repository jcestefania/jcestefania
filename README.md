...
## 🌟 Featured Projects
- **[Pressure Sensor Seat (TFG)](https://github.com/jcestefania/pressure-sensor-seat)**: My Bachelor's Thesis awarded with **Distinction (Matrícula de Honor - 9.6/10)**. An IoT system using ESP32 and piezoresistive sensors for real-time occupancy monitoring and data analysis via Google Cloud.
- **[NLP ChatBot](https://github.com/jcestefania/NLP_ChatBot)**: A conversational assistant developed using Natural Language Processing techniques. It focuses on intent classification, entity recognition, and backend logic for intelligent interactions.
...
- **[Parallel-SwarmOptimization-Project](https://github.com/jcestefania/Parallel-SwarmOptimization-Project)**: A Python project that implements and compares several variants of the Particle Swarm Optimization (PSO) algorithm using different parallelization strategies (threads, processes, asyncio, and a combined approach).
